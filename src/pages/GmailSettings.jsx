...
import {
  ...
  Save, Loader2, RefreshCw, Bell, Phone, UserCircle,
} from "lucide-react";
                  ...
                  {showAddUser && (
                    <div style={{ position: "absolute", top: "calc(100% + 6px)", left: 0, zIndex: 3000, backgroundColor: "white", borderRadius: 12, border: `1px solid ${THEME.border}`, boxShadow: "0 12px 28px rgba(0,0,0,0.12)", minWidth: 220, overflow: "hidden" }}>
                      <div style={{ padding: 6 }}>
                        ...
                        {(staffList || [])
                          .filter(s => !(modal.data.notifyUsers || []).some(u => u.email === s.email))
                          .map(s => {
                            ...
                            return (
                              ...
                              >
                                <div style={{ width: 26, height: 26, borderRadius: "50%", backgroundColor: "#EEF2FF", display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0 }}>
